                            	...
                            	<tr>
                                    ...
                                    <td >
                                        <select class="form-control" name="date" id="distribut_date">
                                                <?php $__FOR_START_12008__=1;$__FOR_END_12008__=31;for($i=$__FOR_START_12008__;$i < $__FOR_END_12008__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($config[date] == $i): ?>selected="selected"<?php endif; ?>><?php echo ($i); ?>天</option><?php } ?>
                                        </select>
                                    </td>
