	               	 ...
	               	 <div class="row">
		  					<div class="col-md-10">
		  						<form action="" method="post">
				  					<div class="col-xs-3">
					  					<a class="btn btn-primary margin" href="<?php echo U('Report/userTop',array('gap'=>7));?>">最近7天</a>
					  					<a class="btn btn-default margin" href="<?php echo U('Report/userTop',array('gap'=>30));?>">最近30天</a>
				  					</div>		  					
								  	<div class="col-xs-5">         
