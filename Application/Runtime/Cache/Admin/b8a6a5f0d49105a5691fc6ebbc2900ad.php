                                ...
                                <tr>
                                    ...
                                    <td >                         		
                                        <select class="form-control" name="auto_confirm_date" id="distribut_date">
                                                <?php $__FOR_START_22785__=1;$__FOR_END_22785__=31;for($i=$__FOR_START_22785__;$i < $__FOR_END_22785__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($config[auto_confirm_date] == $i): ?>selected="selected"<?php endif; ?>><?php echo ($i); ?>天</option><?php } ?>
                                        </select>                                      
                                    </td>
                                </tr>                               
                                </tbody> 
