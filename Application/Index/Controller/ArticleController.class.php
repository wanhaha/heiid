...
class ArticleController extends Controller {
    ...
    public function articleList(){
        ...
        $q && $where .= " and title like '%$q%'  or content like '%$q%'";
    ...
    public function detail_xq(){        
        ...
        $tommer_article_id = D('article')->where(" cat_id = 35 and  article_id > $article_id and publish_time > ".time())->order("article_id asc")->getField('article_id'); 
